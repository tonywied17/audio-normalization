...
<!-- Coverage badge (generated by GaelGirodon/ci-badges-action). Replace <GIST_USER> and <GIST_ID> with your Gist info after configuring the action in your workflow. -->
[![coverage](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/<GIST_USER>/<GIST_ID>/raw/audio-normalization-coverage.json&style=for-the-badge)](https://github.com/tonywied17/audio-normalization)
<!-- Example: https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/youruser/0123456789abcdef/raw/audio-normalization-coverage.json -->
